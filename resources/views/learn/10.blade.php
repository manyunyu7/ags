...
@push("script")
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            const correctValues = [
                38350000000, //1 Tanah
                1180000000, //2 Land Clearing
                7080000000, //3 Pengurugan Tanah
                1180000000, //4 Pemadatan Tanah
                3650000000, //5 Pengerukan Dalam Air
                41328000000, //6 Sarana Pengedokan (.....)
                4200000000, //7 Gudang Penyimpanan
                4200000000, //8 Bengkel Persiapan
                ...
                40000000, //43 IPAL
                51440000000, //44 Investasi Tanah
                72103000000, //45 Investasi Bangunan
                25353625000, //46 Investasi Peralatan
                2970000000, //47 Investasi Persiapan
                151866625000//48 Total Investasi
            ]
            ...
            $('#save-answer').click(function () {
                $('#save-answer').toggleClass('d-none', true);
                let correct = true;
                var correctAnswer = 0;
                var wrongAnswer = 0;
                for (let i = 1; i <= 48; i++) {
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 ">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <span class="current_status badge badge-xl light badge-primary">Kondisi 3</span><br>
                        </div>
                        <div class="card-body">
